...
import roadTexture from '../../assets/images/RoadDiffuse.png'
...
export default class Road extends AbstractObject<MainSceneContext> {
  ...
  parseMaterial = (scene: Object3D) => {
    ...
    const texture = new TextureLoader().load(roadTexture)
